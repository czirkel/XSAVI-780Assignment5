...
$.getJSON( "data/water_quality_complaints.geojson", function( data ) {
    var dataset = data;
...
$.getJSON( "https://data.cityofnewyork.us/resource/qfe3-6dkn.json?$$app_token=cRpSHc65u8P5jUizgPNaic4uS&borough=BROOKLYN&status=Closed", function( data ) {
    var dataset = data;
    // draw the dataset on the map
    plotAPIData(dataset);
